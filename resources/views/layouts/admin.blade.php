...
<head>
    ...
    <!-- FontAwesome CSS -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-p6HgyvmOR6ZjCzhVu8qDe+g3lW6qa2p4+Xj+TzMJ6g1DNO2H7k3nK1/5zwc3tXY6mj8zRFDvd5tj56Pe6vTqLw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <div class="sidebar bg-white w-64 shadow-lg flex flex-col h-full fixed">
        ...
        <div class="p-4 border-b user-info">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-dark">Administrateur</p>
        ...
        <nav class="flex-1 overflow-y-auto">
            <div class="p-2">
                ...
                <a href="#" class="flex items-center px-3 py-3 text-sm font-medium rounded-lg bg-primary bg-opacity-10 text-primary">
            ...
            <div class="p-2">
                ...
                <a href="{{route('products.index')}}" class="flex items-center px-3 py-3 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-100">
                    <i class="fas fa-boxes mr-3"></i>
                    <span class="sidebar-text">Produits</span>
                </a>
                <a href="{{route('categories.index')}}" class="flex items-center px-3 py-3 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-100">
                    <i class="fas fa-tags mr-3"></i>
                    <span class="sidebar-text">Catégories</span>
                </a>
                <a href="#" class="flex items-center px-3 py-3 text-sm font-medium rounded-lg text-gray-700 hover:bg-gray-100">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @if (Route::currentRouteName() === 'categories.index')
                        ...
                        <button onclick="openModal()" class="bg-primary text-white px-4 py-2 rounded-lg">+ Ajouter une catégorie</button>
